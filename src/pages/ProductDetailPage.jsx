...
function ProductDetailPage() {
  ...
  return (
    <div className="product-detail-screen">
      <section className="product-detail-band product-detail-band--hero">
        <div className="product-detail-band__inner">
      ...
      <section className="product-detail-band product-detail-band--tabs">
        <div className="product-detail-band__inner">
      ...
      <section className="product-detail-band product-detail-band--related">
        <div className="product-detail-band__inner">
