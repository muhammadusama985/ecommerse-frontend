...
const baseTranslations = {
  ...
  chatbotOpen: "Open shopping assistant",
  chatbotTitle: "Shopping Assistant",
  chatbotSubtitle: "Ask about products, categories, shipping, and general store info.",
  chatbotWelcomeCopy: "Hi, I'm here to help you explore products, categories, best sellers, shipping, payment methods, and general store information.",
  chatbotInputPlaceholder: "Ask about products or store info...",
  chatbotFallbackReply: "I could not answer that right now. Please try another product or store question.",
  ...
  categoriesPageCopy: "Explore every beauty category in one place and jump straight into the products that match your interest.",
  searchLabel: "Search",
